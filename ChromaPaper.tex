...
%Given the variety of different key templates proposed in the literature, we search for evidence that musical genre impacts the key profile. 
%
...
Key annotations for the tracks are publicly available.\footnote{\url{AuthorsGitHub}}%github.com/alexanderlerch/data_set}}
...
A SVM classifier with the key profiles and the results are compared to base-line results computed with a $24$-dimensional timbre feature vector comprising the mean and standard deviation of $12$ MFCCs. %The MFCC were calculated using a freely available MATLAB implementation.\footnote{\url{http://labrosa.ee.columbia.edu/matlab/rastamat/}}
