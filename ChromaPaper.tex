...
Tables \ref{tab:confMatMajPC} and \ref{tab:confMatMinPC} display the confusion matrices of the classification results. 
%\begin{figure}[tb]
...
\hline
    ...
    \caption{Confusion matrix, major PC.}
...
\hline
    ...
    \caption{Confusion matrix, minor PC.}
